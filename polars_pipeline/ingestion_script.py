...
def get_schema_monthly() -> dict:
    dict_schema = {
        'zip5': pl.Utf8,
        'zip9_code': pl.Int32,
        'bankcard_limit': pl.Float64,
        'bankcard_balance': pl.Float64,
        'bankcard_trades': pl.Float64,
        'bankcard_util': pl.Float64,
        'total_revolving_limit': pl.Float64,
        'total_revolving_balance': pl.Float64,
        'total_revolving_trades': pl.Float64,
        'total_revolving_util': pl.Float64,
        'mortgage1_limit': pl.Float64,
        'mortgage1_balance': pl.Float64,
        'mortgage1_open': pl.Float64,
        'mortgage2_limit': pl.Float64,
        'mortgage2_balance': pl.Float64,
        'mortgage2_open': pl.Float64,
        'mortgage3_limit': pl.Float64,
        'mortgage3_balance': pl.Float64,
        'mortgage3_open': pl.Float64,
        'mortgage4_limit': pl.Float64,
        'mortgage4_balance': pl.Float64,
        'mortgage4_open': pl.Float64,
        'mortgage5_limit': pl.Float64,
        'mortgage5_balance': pl.Float64,
        'mortgage5_open': pl.Float64,
        'total_mortgage_limit': pl.Float64,
        'total_mortgage_balance': pl.Float64,
        'total_mortgage_trades': pl.Float64,
        'mortgage1_loan_to_value': pl.Float64,
        'homeequity1_limit': pl.Float64,
        'homeequity1_balance': pl.Float64,
        'homeequity1_open': pl.Float64,
        'homeequity2_limit': pl.Float64,
        'homeequity2_balance': pl.Float64,
        'homeequity2_open': pl.Float64,
        'homeequity3_limit': pl.Float64,
        'homeequity3_balance': pl.Float64,
        'homeequity3_open': pl.Float64,
        'homeequity4_limit': pl.Float64,
        'homeequity4_balance': pl.Float64,
        'homeequity4_open': pl.Float64,
        'homeequity5_limit': pl.Float64,
        'homeequity5_balance': pl.Float64,
        'homeequity5_open': pl.Float64,
        'total_homeequity_limit': pl.Float64,
        'total_homeequity_balance': pl.Float64,
        'total_homeequity_trades': pl.Float64,
        'homeequity1_loan_to_value': pl.Float64,
        'autoloan_open': pl.Float64,
        'studentloan_open': pl.Float64,
        'bankcard_open': pl.Float64,
        'homeequity_open': pl.Float64,
        'mortgage_open': pl.Float64,
    }
    return dict_schema
